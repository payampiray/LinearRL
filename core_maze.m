function [id, rr, cc, ptr_left, ptr_up, ptr_right, ptr_down] = core_maze(row,col,pattern)
...
thyme = the_maze;
thyme = [id ptr_left, ptr_up, ptr_right, ptr_down];
return;
...
line([.5,.5],[0.5,row+.5]) % draw left border
